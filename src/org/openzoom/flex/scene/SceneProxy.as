...
//*******************************************************************
		...
		{
			super.x = value;
			dispatchEvent(new SceneProxyChangeEvent(value, y, width, height));
		}
		
		override public function set y(value:Number):void
		{
			super.y = value;
			dispatchEvent(new SceneProxyChangeEvent(x, value, width, height));
		} 
		
		override public function set width(value:Number):void
		{
			super.width = value;
			dispatchEvent(new SceneProxyChangeEvent(x, y, value, height));
		}
		
		override public function set height(value:Number):void
		{
			super.height = value;
			dispatchEvent(new SceneProxyChangeEvent(x, y, width, value));
		}
	}
}